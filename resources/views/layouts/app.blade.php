                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                      <li class="nav-item"><a class="nav-link" href="{{ route('projects.index') }}">All Projects</a></li>
                                      ...
                                      <li class="nav-item"><a class="nav-link" href="{{ route('companies.index') }}">All Companies</a></li>
